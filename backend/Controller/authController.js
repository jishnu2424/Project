...
const addUserOrDesigner = async (req, res) => {
    try {
...
const loginUserOrDesigner = async (req, res) => {
    try {
      ...
      const token = jwt.sign({ sub: findUser }, process.env.JWT_TOKEN, { expiresIn:'1d'})
...
module.exports = { loginUserOrDesigner, addUserOrDesigner};