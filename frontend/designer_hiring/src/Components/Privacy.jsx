  ...
  return (
    <>
      <div className="pdiv1">
        ...
        <h4 className="ph4">Last Revised: June 14, 2024</h4>
      </div>
      <div className="content">
        <p className="cnt">
          PLEASE READ THIS PRIVACY POLICY (THE “POLICY”) CAREFULLY TO UNDERSTAND
          HOW DESIGNER HIRING INTERNATIONAL LTD., CALICUT INDIA (“DESIGNER
          HIRING ”, “WE”) USES PERSONAL INFORMATION. BY ACCESSING OR USING
          WWW................., THE MOBILE APP, OR ANY OTHER RELATED SITES,
          APPLICATIONS, SERVICES AND GOODS, OR ANY OTHER WEBSITE OPERATED BY
          DESIGNER HIRING THAT LINKS TO THIS POLICY (EACH, THE “SITE”), YOU
          ACKNOWLEDGE THAT YOU HAVE READ AND UNDERSTOOD THIS POLICY. THIS POLICY
          MAY CHANGE FROM TIME TO TIME; ANY CHANGES WE MAKE TO THIS POLICY WILL
          BE POSTED ON THIS SITE, WE WILL ALSO TAKE ANY OTHER STEPS, TO THE
          EXTENT REQUIRED BY APPLICABLE LAW, INCLUDING NOTIFYING YOU ABOUT
          MATERIAL CHANGES. CHANGES TO THIS POLICY ARE EFFECTIVE AS OF THE
        ...
        <p className="pp">
          ...
          designers with people and companies in need of their skills. In order
